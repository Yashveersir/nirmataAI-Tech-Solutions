...
export function WhyChooseUs() {
  return (
    <Section tone="muted" id="why-choose-us" className="relative overflow-hidden">
      ...
      <div className="absolute -bottom-24 right-10 -z-10 size-80 rounded-full bg-accent/5 blur-3xl" />
              ...
              return (
                ...
                >
                  <CardHeader className="pb-2">
                    <div className="bg-accent/10 border border-accent/20 text-accent flex size-12 items-center justify-center rounded-xl mb-4 group-hover:scale-110 transition-transform duration-300">
                      <Icon
                        className="size-6"
                        aria-hidden="true"
                        strokeWidth={2}
                    ...
                    <CardTitle className="text-xl font-display font-bold group-hover:text-accent transition-colors duration-300">
                      {value.title}
                    </CardTitle>
                  </CardHeader>
