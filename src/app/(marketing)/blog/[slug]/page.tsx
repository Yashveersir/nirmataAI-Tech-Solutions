    ...
    <>
      ...
      <AnimatedSection as="div">
        <Container size="md" className="py-12">
          <Link
            href="/blog"
            className="text-foreground/70 hover:text-foreground mb-8 inline-flex items-center gap-2 text-sm transition-colors"
          >
        ...
        <Container size="md">
          <article>
            <header className="space-y-6">
              ...
              <div className="text-foreground/70 flex flex-wrap items-center gap-4 text-sm">
      ...
      <AnimatedSection as="div" delay={0.1}>
        <Container size="md" className="pb-20">
          <div className="prose prose-neutral max-w-none dark:prose-invert text-foreground/90">
              ...
              <div className="flex items-center gap-3">
                <div className="bg-muted flex size-12 items-center justify-center rounded-full">
                  {post.author.avatar ? (
                    ...
                    <User className="text-foreground/60 size-5" aria-hidden="true" />
                  )}
                </div>
                <div>
        ...
        <div className="bg-muted py-20">
          <Container size="sm">
            <div className="text-center">
              ...
              <p className="text-foreground/80 mx-auto mt-4 max-w-lg text-lg">
