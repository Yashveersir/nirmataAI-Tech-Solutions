...
const inquiryTypes = [
  ...
  { value: "ai-solutions", label: "AI Solutions & Chatbot" },
  { value: "whatsapp-automation", label: "WhatsApp Business Automation" },
  { value: "custom-software", label: "Enterprise Custom Software" },
...
export default function ContactPage() {
  ...
  const handleCloseDialog = (open: boolean) => {
    if (!open && dialogStatus === 'success') {
      setForm(initialForm); // Reset form on success close
    }
    setDialogOpen(open);
    if (!open) {
      setTimeout(() => setDialogStatus('idle'), 300); // Reset after animation
    }
  };
          ...
          {dialogStatus === 'sending' && (
            <>
              ...
              <DialogHeader className="items-center">
                <DialogTitle className="text-2xl">Sending Message...</DialogTitle>
